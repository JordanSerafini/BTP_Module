...
async function seedDatabase() {
  ...
  const chantiers = await Chantier.insertMany([
    ...
    },
    {
      ...
      commentaires: ['Début prévu le 20/12/2024', 'Prévoir sous-couche isolante'],
    ...
    },
    {
      ...
      adresse: '56 Boulevard Haussmann',
      code_postal: '75008',
      ville: 'Paris',
      localisation: { lon: 2.323224, lat: 48.874245 },
    },
    {
      numero: 'CH-004',
      ...
      commentaires: ['Travaux prévus à partir du 05/01/2025', 'Prévoir sous-couche isolante'],
    ...
    },
    {
      ...
      commentaires: ['En cours depuis le 10/12/2024', 'Prévoir joint silicone', 'Vérifier les délais de séchage'],
      ...
      code_postal: '44000',
      ville: 'Nantes',
      localisation: { lon: -1.553621, lat: 47.218371 },
    },
    {
      numero: 'CH-006',
    ...
    },
    {
      ...
      commentaires: ['Chantier terminé en novembre 2024', 'Prévoir joint silicone'],
      client: 'Clara Petit',
      status: 'Terminé',
    ...
    },
    {
      ...
      commentaires: ['Début prévu le 15/12/2024', 'Prévoir vernissage parquet'],
      client: 'Marie Curie',
      status: 'À venir',
    ...
    },
    {
      ...
      commentaires: ['Chantier démarré le 01/12/2024', 'Prévoir vernissage parquet'],
      client: 'Emma Robert',
      status: 'En cours',
      debut_prevu: new Date('2024-12-01'),
    ...
    },
    {
      ...
      commentaires: ['Chantier prévu pour février 2025', 'Vérifier les délais de séchage', 'Prévoir joint silicone'],
      client: 'Marc Leclerc',
      status: 'À venir',

...
function Part_Staff({ chantier, refreshChantier }: PartProps) {
  ...
  const updateChantier = async () => {
    ...
    try {
      ...
      setToast("Chantier mis à jour avec succès", "success", { autoClose: 2000, closeOnClick: true, position: "top-center" });
      refreshChantier();
    } catch (error) {
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-lg border flex ">
